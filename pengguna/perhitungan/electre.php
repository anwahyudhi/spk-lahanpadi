        ...
        <div class="wrapper">
            <div id="content">
                ...
                <div class="panel panel-heading">
                    <h2>Proses Perhitungan ELECTRE</h2>
                </div>
                <div class="panel-body">
                  <div class="container">
                     <a href="perhitungan.php" class="btn btn-success btn-fill">
                        ...
                        <a href="topsis.php" class="btn btn-success btn-fill">
                        <span>Proses Perhitungan TOPSIS</span>
                        </a>
                        <br><br>
                  	...
                  	<thead>
                  		<tr>
                            ...
                            ?>
                              ...
                              <td scope="col"><?php echo $data['nama_kriteria']?></th>
                	...
                	<div class="panel-body">
                		<div class="container">
                            ...
                            ?>
                              ...
                              <td><?php echo $data['nama_kriteria']?></th>
		                ...
		                <tr>
		                	...
		                	<td><?php echo $data['nama_alternatif'] ?></td>
		                	<td><?php
				              $ntp1[$i] = $sub1[$i]/sqrt($powtal1);
				              echo number_format($ntp1[$i],2);?></td>
				              <td><?php
				              $ntp2[$i] = $sub2[$i]/sqrt($powtal2);
				              echo number_format($ntp2[$i],2);?></td>
				              <td><?php
				              $ntp3[$i] = $sub3[$i]/sqrt($powtal3);
				              echo number_format($ntp3[$i],2);?></td>
				              <td><?php
				              $ntp4[$i] = $sub4[$i]/sqrt($powtal4);
				              echo number_format($ntp4[$i],2);?></td>
				              <td><?php
				              $ntp5[$i] = $sub5[$i]/sqrt($powtal5);
				              echo number_format($ntp5[$i],2);?></td>
		                </tr>
		                <?php 
                        $i++;
...
<div class="panel">
    <div class="container">
        ...
        $hasil=mysqli_fetch_array($query);
         ...
         ?>
        <center><h3>Berdasarkan hasil perhitungan diatas menggunakan metode ELECTRE, dapat disimpulkan bahwa Lahan Padi yang direkomendasikan berada di <?php echo $hasil['nama_alternatif']; ?></h3></center>
