            ...
            <div id="content">
                ...
                <nav class="navbar navbar-default justify-content-center" style="background: #e5f5df">
                    <div class="container-fluid">
                      ...
                      <li class="active"><a href="data_kriteria.php">Info Kriteria</a></li>
                  ...
                  <table class="table table-bordered">
                  	...
                  	<tbody>
		                ...
		                <tr>
                            ...
                            <td>
                                <?php
                                $queryx=mysqli_query($dbh,"select count(*) as jumlah from sub_kriteria where id_kriteria='$id'");
